...
async def get_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"BRANDEDXMUSIC/assets/circle.png")
        ...
        font = ImageFont.truetype("BRANDEDXMUSIC/assets/font2.ttf", 45)
        ImageFont.truetype("BRANDEDXMUSIC/assets/font2.ttf", 70)
        arial = ImageFont.truetype("BRANDEDXMUSIC/assets/font2.ttf", 30)
        ImageFont.truetype("BRANDEDXMUSIC/assets/font.ttf", 30)
