...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"BRANDEDXMUSIC/Helpers/utils/circle.png")
        ...
        font = ImageFont.truetype("BRANDEDXMUSIC/Helpers/utils/font2.ttf", 45)
        ImageFont.truetype("BRANDEDXMUSIC/Helpers/utils/font2.ttf", 70)
        arial = ImageFont.truetype("BRANDEDXMUSIC/Helpers/utils/font2.ttf", 30)
        ImageFont.truetype("BRANDEDXMUSIC/Helpers/utils/font.ttf", 30)
